  ...
  render () {
    ...
    return (
      <div className='status__action-bar'>
        ...
        />
        <IconButton className={classNames('status__action-bar-button', { reblogPrivate })} disabled={!publicStatus && !reblogPrivate} active={status.get('reblogged')} title={reblogTitle} icon={reblogIcon} iconComponent={reblogIconComponent} onClick={this.handleReblogClick} counter={status.get('favourites_count')} obfuscateCount={showReplyCount} />
        <IconButton className='status__action-bar-button favorite-icon' animate active={status.get('favourited')} title={intl.formatMessage(messages.favourite)} icon='favorite' iconComponent={status.get('favourited') ? FavoriteIcon : FavoriteBorderIcon} onClick={this.handleFavouriteClick} counter={status.get('favourites_count')} obfuscateCount={showReplyCount}/>
