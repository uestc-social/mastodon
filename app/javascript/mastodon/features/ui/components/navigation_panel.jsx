...
import FavoriteActiveIcon from '@/material-icons/400-24px/favorite-fill.svg';
import FavoriteIcon from '@/material-icons/400-24px/star.svg?react';
        ...
        <div className='navigation-panel__menu'>
          ...
          {signedIn && (
            <>
              ...
              <ColumnLink transparent to='/favourites' icon='favorite' iconComponent={FavoriteIcon} activeIconComponent={FavoriteActiveIcon} text={intl.formatMessage(messages.favourites)} />
