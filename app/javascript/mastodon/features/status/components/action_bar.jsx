...
import FavoriteBorderIcon from '@/material-icons/400-24px/favorite_border.svg?react';
  ...
  render () {
    ...
    return (
      <div className='detailed-status__action-bar'>
        ...
        <div className='detailed-status__button'><IconButton className='favorite-icon' animate active={status.get('favourited')} title={intl.formatMessage(messages.favourite)} icon='favorite' iconComponent={status.get('favourited') ? FavoriteIcon : FavoriteBorderIcon} onClick={this.handleFavouriteClick} /></div>
