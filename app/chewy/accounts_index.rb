...
class AccountsIndex < Chewy::Index
  ...
  root date_detection: false do
    ...
    field(:display_name, type: 'text', analyzer: 'verbatim') do
      field :edge_ngram, type: 'text', analyzer: 'edge_ngram', search_analyzer: 'verbatim'
      field :chinese, type: 'text', analyzer: 'chinese_ik'
    end
    field(:username, type: 'text', analyzer: 'verbatim', value: ->(account) { [account.username, account.domain].compact.join('@') }) { field :edge_ngram, type: 'text', analyzer: 'edge_ngram', search_analyzer: 'verbatim' }
    field(:text, type: 'text', analyzer: 'verbatim', value: ->(account) { account.searchable_text }) do
